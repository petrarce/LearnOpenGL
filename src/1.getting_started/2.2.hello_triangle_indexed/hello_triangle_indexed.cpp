...
//	}
	...
	fragmentShader.compile(std::string(fragmentShaderSource, sizeof(vertexShaderSource)));
	std::cerr << fragmentShader.compilationLog() << std::endl;
...
//    glDeleteShader(fragmentShader);
	...
	std::cout << program.linkageLog() << std::endl;
